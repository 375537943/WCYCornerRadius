...
/////////////////////////////////////////////////////////////////////
@interface WCYImageObserver : NSObject
...
@implementation WCYImageObserver
...
/////////////////////////////////////////////////////////////////////
@implementation UIImageView (WCYCornerRadius)
...
- (WCYImageObserver *)imageObserver {
    WCYImageObserver *imageObserver = objc_getAssociatedObject(self, @selector(imageObserver));
    if (!imageObserver) {
        imageObserver = [[WCYImageObserver alloc] initWithImageView:self];
